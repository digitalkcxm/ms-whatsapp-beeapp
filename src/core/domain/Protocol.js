...
export default class Protocol {
  ...
  static newIncomingProtocol(instanceId = null, configId = null, companySettingsId = null, phone = '', phoneInternational = false) {
  ...
  static newOutgoingProtocol(instanceId = null, configId = null, companySettingsId = null, phone = '', phoneInternational = false) {
    const p = new Protocol()
    p.instanceId = instanceId
    p.configId = configId
    p.companySettingsId = companySettingsId
