...
export default function messageRoutes(database, logger = console) {
  ...
  const messageController = new MessageController(logger, messageRepository, protocolRepository, whatsappInstanceRepo, companySettingsRepo, beeappIntegration, coreIntegration, companyIntegration);
