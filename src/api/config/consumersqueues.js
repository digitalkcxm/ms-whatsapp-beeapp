...
export async function startConsumersQueues() {
  ...
  const messageController = new MessageController(console, messageRepo, protocolRepo, whatsappInstanceRepo, companySettingsRepo, beeAppIntegration, coreIntegration, companyIntegration);
